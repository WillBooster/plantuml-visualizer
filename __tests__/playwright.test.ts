...
test("code block in GitHub's README", async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/blob/master/puml-sample/README.md');
...
test("code block in GitHub's issue", async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/issues/54');
...
test('file block without preprocessing directive in GitHub', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/blob/master/puml-sample/class.pu');
...
test('file block with !include directive in GitHub', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/blob/master/puml-sample/including.pu');
...
test('file block with !includesub directive in GitHub', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/blob/master/puml-sample/subincluding.pu');
...
test('pull request adding a PlantUML file', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/pull/49/files');
...
test('pull request deleting a PlantUML file', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/pull/50/files');
...
test('pull request changing a PlantUML file', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/pull/24/files');
...
test('pull request renaming a PlantUML file with a little changes', async ({ page }) => {
  page.goto('https://github.com/WillBooster/plantuml-visualizer/pull/106/files');
